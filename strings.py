...
ar_mean_average = "По общим стандартам ваш показатель AR средний, сложно сделать вывод об эффективности вашего сообщества."
...
err_mean_average = "По общим стандартам ваш показатель ERR средний, сложно сделать вывод об эффективности вашего сообщества."
err_mean_high = "Поздравляем! По общим стандартам ваш показатель ERR высокий."